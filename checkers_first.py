...
This was my first attempt at my checkers project. It's incredibly basic and fails to implement a lot 
of the ideas that are used in my final version, checkers.py, like the use of a game, board, or graphics object,
and the compartimentalization of having my game state be completely seperate from the items drawn on screen, making 
the use of a min-max AI possible sometime in the future.

Functionally, this program draws the board and pieces to the screen and gives the user the ablity to drag and drop them around,
not being locked to a grid.
